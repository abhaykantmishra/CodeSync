...
export default function Component() {
  ...
  return (
    <div className="bg-[#0d1117] p-4 rounded-lg mx-auto text-[#7d8590] overflow-hidden">
      <h2 className="text-lg font-semibold mb-2 text-white">
        {contributionData.reduce((sum, count) => sum + count, 0)} contributions in the last year
      </h2>
      <div className="flex overflow-x-auto pb-4">
        <div className="flex-shrink-0 flex flex-col justify-between mr-2 text-xs sticky left-0 bg-[#0d1117] z-10">
